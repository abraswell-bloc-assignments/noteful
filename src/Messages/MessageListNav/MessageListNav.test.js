...
import MessageListNav from './MessageListNav'
...
it('renders without crashing', () => {
  ...
  describe(`MessageListNav component`, () => {
    const props = {
      messages: [
        {
    ...
    it('renders a .MessageListNav by default', () => {
      const wrapper = shallow(<MessageListNav />)
      expect(toJson(wrapper)).toMatchSnapshot()
  Message
    
  
    it('renders a link in ul for each member in array', () => {
      const wrapper = shallow(<MessageListNav {...props} />)
      expect(toJson(wrapper)).toMatchSnapshot()
    })
  })